    ...
    <div className="w-[22rem] pr-4 space-y-6">
      <div>
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-semibold mb-4">{t("find:type")}</h2>
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="fullTime">{t("find:full")}</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              id="partTime"
            ...
            />
            <Label htmlFor="partTime">{t("find:part")}</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              id="contract"
            ...
            />
            <Label htmlFor="contract">{t("find:contract")}</Label>
          </div>
          <div className="flex items-center space-x-2">
            <Checkbox
              id="internship"
            ...
            />
            <Label htmlFor="internship">{t("find:internship")}</Label>
          </div>
        </div>
      </div>
      ...
      <div>
        <h2 className="text-lg font-semibold mb-4">{t("find:salary")}</h2>
        <div className="flex flex-col gap-4">
          <Label htmlFor="minSalary">{t("find:min")}</Label>
          <Slider
            id="minSalary"
            min={0}
            max={200000}
      ...
      <div className="flex flex-col gap-4">
        <Label htmlFor="maxSalary">{t("find:max")}</Label>
        <Slider
          id="maxSalary"
          min={0}
          max={200000}
